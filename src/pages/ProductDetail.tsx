...
import { ArrowLeft, Star, MapPin, Share2, Heart, Phone, MessageCircle } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-start justify-between mb-6">
          ...
          <div className="text-right">
            <div className="text-sm text-muted-foreground mb-1">Package starting from</div>
            <div className="text-2xl font-bold text-primary mb-2">{venue.pricePerPax}</div>
            <div className="text-sm text-muted-foreground mb-3">Per Pax</div>

    ...
    <div className="min-h-screen bg-[#FFF8F4] text-gray-900">
      ...
      <section className="container mx-auto px-4 py-10 md:py-16">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            { name: "Daniel", role: "CHIEF CELEBRATION OFFICER", img: "/blue_boy.jpg" },
            { name: "Allegra", role: "CHIEF IMAGINATION OFFICER", img: "/girl_lipstick_theme.jpg" },
            { name: "Mavis", role: "CHIEF AESTHETIC OFFICER", img: "/marigold.jpg" },
            { name: "Sudhanshu", role: "CHIEF STORYTELLING OFFICER", img: "/mickey.jpg" },
          ].map((m) => (

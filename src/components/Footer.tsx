        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 text-sm hover:text-red-800 transition-colors">Blog</a></li>
              <li><a href="#" className="text-gray-600 text-sm hover:text-red-800 transition-colors">Stars Born</a></li>
            </ul>
          </div>
